...
<div class="app" data-headers-url="{{ route('labels.headers') }}">
    <nav class="app-nav" aria-label="Navigation principale"><a class="app-nav-link active" href="{{ route('labels.index') }}">Etiquettes</a><a class="app-nav-link" href="{{ route('inventories.index') }}">Inventaire</a><a class="app-nav-link" href="{{ route('article-references.index') }}">Referentiel articles</a><a class="app-nav-link" href="{{ route('catalogue.index') }}">Catalogue QR</a></nav>
